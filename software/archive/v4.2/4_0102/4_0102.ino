const char ver[] = "v4.0102";    // версия прошивки
...
const char MQTTUSER[]    =  "jhdurkd";                    // имя пользователя (логин)  (смотрим в аккаунте MQTT)
const char MQTTPASSWORD[] = "fllksjg48jgo";               // пароль                    (смотрим в аккаунте MQTT)
const char SERVERNAME_PORT[] = "\"farmer.cloudmqtt.com\", \"16342\"";  // адрес и порт (смотрим в аккаунте MQTT)
