const char ver[] = "Firmware 3.90";    // версия прошивки
...
const char MQTTUSER[]    =  "iudnbwbw";                      // это смотрим на сервере MQTT
const char MQTTPASSWORD[] = "1QHD2pOrCcBW";                    // это смотрим на сервере MQTT
const char SERVERNAME_PORT[] = "\"m16.cloudmqtt.com\", \"17225\"";  // это смотрим на сервере MQTT
