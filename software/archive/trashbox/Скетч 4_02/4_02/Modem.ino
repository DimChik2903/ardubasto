...
void NastroykaGSM () {
  ...
  else if (currmillis - prevGSMnastr > delayATcommand)
  {
    ...
    else if (gsmstatus == setSubPack)       {char sub[30]={0}; strcpy (sub, MQTTUSER); strcat (sub, "/c/#"); SUBsend(sub);}
...
void DTCareCleared() {startSMS (KTOzapros); SIM800.println (F("DTC are cleared!")); EndSMS(); needAction=0; w_bus_init = 9; NeedTimer = 0; }
