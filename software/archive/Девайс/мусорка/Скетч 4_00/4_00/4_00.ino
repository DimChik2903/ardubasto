const char ver[] = "Firmware v4.00";    // версия прошивки
...
const char PROTOCOLIUS[] =  "MQIsdp";                      // так и оставляем
const char MQTTNAME[]    =  "blabla";                      // это смотрим на сервере MQTT
const char MQTTUSER[]    =  "blablabla";                   // это смотрим на сервере MQTT
const char MQTTPASSWORD[] = "blablablabla";                // это смотрим на сервере MQTT
const char SERVERNAME_PORT[] = "\"bla.cloudmqtt.com\", \"11111\"";  // это смотрим на сервере MQTT
...
const char CTRL_HEAT_TOP[]    = "c/heat";
const char CTRL_TIME_TOP[]    = "c/time";
const char CTRL_TIMEENG_TOP[] = "c/Engtime";
const char CTRL_REFRESH_TOP[] = "c/refr";
const char CTRL_RESRES_TOP[]  = "c/resres";
const char CTRL_LOCK_TOP[]    = "c/lock";
const char CTRL_DVS_TOP[]     = "c/dvs";


const char STAT_HEAT_TOP[]    = "s/heat";
const char STAT_TIME_TOP[]    = "s/time";
const char STAT_RESETS_TOP[]  = "s/resets";
const char STAT_FLAME_TOP[]   = "s/flame";
const char STAT_POWER_TOP[]   = "s/power";
const char STAT_DTS_TOP[]     = "s/dtc";
const char STAT_LEVEL_TOP[]   = "s/level";
const char STAT_NAPR_TOP[]    = "s/napr";
const char STAT_REMTIME_TOP[] = "s/remtime";
const char STAT_ENGTIME_TOP[] = "s/engtime";
const char tHEAT_TOP[]        = "s/temp/heat";
const char tDVS_TOP[]         = "s/temp/dvs";
const char tUL_TOP[]          = "s/temp/ul";
const char tSAL_TOP[]         = "s/temp/sal";
const char tVYH_TOP[]         = "s/temp/vyh";
const char STAT_ENGINE_TOP[]  = "s/dvs";
const char STAT_IGN_TOP[]     = "s/ign";
const char STAT_OHR_TOP[]     = "s/ohr";
const char STAT_TREV_TOP[]    = "s/trev";
