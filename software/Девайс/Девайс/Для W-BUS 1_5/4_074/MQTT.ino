...
void  MQTTsendDatastream() 
{
  ...
  PUBsend (PGM_Text(_STAT_WPUMP_TOP),  Var_to_text(waterpump,   0),   1);
  PUBsend (PGM_Text(_STAT_PLUG_TOP),   Var_to_text(plug,        0),   1);
  PUBsend (PGM_Text(_STAT_AIRFAN_TOP), Var_to_text(airfan,      0),   1);
  PUBsend (PGM_Text(_STAT_FPUMP_TOP),  Var_to_text(fuelpump,    0),   1);
