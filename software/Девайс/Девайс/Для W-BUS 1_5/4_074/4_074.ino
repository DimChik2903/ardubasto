const char ver[] = "v4.074";    // версия прошивки
//данная версия скетч только для w_bus v1.5!!!
...
#define BAUDRATE_MODEM 9600  // скорость UART  связи с модемом
...
const char STAT_AIRFAN_TOP[]  PROGMEM = "s/aif";
...
pinMode (ResetGSM,           OUTPUT);  digitalWrite (ResetGSM,        !RelayON);  // реле ресет на данный момент делаем "неактивно"
  ...
  SIM800.begin(BAUDRATE_MODEM);           // сериал соединение для gsm модуля
