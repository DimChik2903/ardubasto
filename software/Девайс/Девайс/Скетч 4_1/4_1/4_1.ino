const char ver[] = "v4.1";    // версия прошивки
...
bool mqtt = 0;          // работа по MQTT (интернету) 1 - включено, 0 - выключено.  
...
const char MQTTUSER[]    =  "vfgfkgjks";                  // имя пользователя (логин)  (смотрим в аккаунте MQTT)
const char MQTTPASSWORD[] = "dgd'gldg,,b";                // пароль                    (смотрим в аккаунте MQTT)
const char SERVERNAME_PORT[] = "\"farmer.cloudmqtt.com\", \"15465\"";  // адрес и порт (смотрим в аккаунте MQTT)
