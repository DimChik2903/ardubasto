...
{ 
  ...
  if (ProtocolSTATUS==ANALOG) {  if (DS18B20[VyhlopC].Temper - DS18B20[UlicaC].Temper > delta) startWebasto_OK = 1;
...
if (StartEng_timer && currmillis - prevStartEng > (uint32_t)EngineTime * 1000ul ) {digitalWrite (StartEng, 0); StartEng_timer=0;}
