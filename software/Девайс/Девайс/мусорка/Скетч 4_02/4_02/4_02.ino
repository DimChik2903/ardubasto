const char ver[] = "v4.02"; // версия прошивки

#define WBUS_heaters      // тут раскомментируем одну из строчек 
//#define TTE_C_heaters       // с нужным типом котла

//#define Signalka          // раскомментиовать , если к девайсу подключена сигнализация
...
const char MQTTUSER[]    =  "user_kjdu9478";                       // это смотрим на сервере MQTT
const char MQTTPASSWORD[] = "pass_83jfu675";                       // это смотрим на сервере MQTT
const char SERVERNAME_PORT[] = "\"srv1.clusterfly.ru\", \"9165\""; // это смотрим на сервере MQTT
#define TIMEBROKER 20   // таймаут бездействия клиента брокера, минут. Если превысить - с сервера выкинет. Так и оставляем. 

//---------------------------Топики MQTT--------------------------------------------------------------------------------
#define ENDSTR 1
const char WAIT[] = "wait";
const char FAIL[] = "fail";
const char VYKL[] = "выкл";

const char CTRL_HEAT_TOP[]    = "c/hea";
const char CTRL_TIME_TOP[]    = "c/tim";
const char CTRL_TIMEENG_TOP[] = "c/Eti";
const char CTRL_REFRESH_TOP[] = "c/ref";
const char CTRL_RESRES_TOP[]  = "c/Res";
const char CTRL_LOCK_TOP[]    = "c/loc";
const char CTRL_DVS_TOP[]     = "c/dvs";


const char STAT_HEAT_TOP[]    = "s/hea";
const char STAT_TIME_TOP[]    = "s/tim";
const char STAT_RESETS_TOP[]  = "s/res";
const char STAT_FLAME_TOP[]   = "s/fla";
const char STAT_POWER_TOP[]   = "s/pow";
const char STAT_DTS_TOP[]     = "s/dtc";
const char STAT_LEVEL_TOP[]   = "s/lev";
const char STAT_NAPR_TOP[]    = "s/nap";
const char STAT_REMTIME_TOP[] = "s/rti";
const char STAT_ENGTIME_TOP[] = "s/eti";
const char tHEAT_TOP[]        = "s/t/h";
const char tDVS_TOP[]         = "s/t/d";
const char tUL_TOP[]          = "s/t/u";
const char tSAL_TOP[]         = "s/t/s";
const char tVYH_TOP[]         = "s/t/v";
const char STAT_ENGINE_TOP[]  = "s/dvs";
const char STAT_IGN_TOP[]     = "s/ign";
const char STAT_OHR_TOP[]     = "s/ohr";
const char STAT_TREV_TOP[]    = "s/tre";
...
const char PROTOCOLIUS[] =  "MQIsdp";                      // для MQTT
const char MQTTNAME[]    =  "b";                           // для MQTT
...
char buffeR[16] = {0}; // буффер для работы функций строк прогмем и конвертации переменных в char 
