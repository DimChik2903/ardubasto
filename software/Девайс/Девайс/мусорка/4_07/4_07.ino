const char ver[] = "v4.07";    // версия прошивки
...
const char MQTTUSER[]    =  "vafhulfs";                   // имя пользователя (логин)  (смотрим в аккаунте MQTT)
const char MQTTPASSWORD[] = "Pegt62edaT2z";               // пароль                    (смотрим в аккаунте MQTT)
const char SERVERNAME_PORT[] = "\"farmer.cloudmqtt.com\", \"14572\"";  // адрес и порт (смотрим в аккаунте MQTT)
