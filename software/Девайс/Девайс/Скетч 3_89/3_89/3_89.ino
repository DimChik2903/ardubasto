const char ver[] = "Firmware 3.89";    // версия прошивки
...
const char MQTTPASSWORD[] = "1    BW";          // это смотрим на сервере MQTT
const char SERVERNAME_PORT[] = "\"m16.cloudmqtt.com\", \"15689\"";       // это смотрим на сервере MQTT
