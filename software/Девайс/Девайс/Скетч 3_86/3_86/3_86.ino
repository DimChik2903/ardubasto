const char ver[] = "Firmware 3.86";    // версия прошивки
...
const char MQTTUSER[]    =  "i    w";              // это смотрим на сервере MQTT
const char MQTTPASSWORD[] = "1    W";          // это смотрим на сервере MQTT
const char SERVERNAME_PORT[] = "\"m16.cloudmqtt.com\", \"15675\"";       // это смотрим на сервере MQTT
...
enum gsmstatus_  
{
  ...
  setGPRS, setAccPoint, setGPRSconnect, setBrokerconnect, setAuthPack, setSubPack, setPubPack  // настройки для MQTT
};
