...
else if (!currStr.compareTo(F("MQTT-reset")))   {MQTTrestart();}                     // рестарт модема и MQTT 
            ...
            isStringMessage = 0;
              ...
              startSMS(1); SIM800.println(F("Tel Number#1 is saving in memory"));  SIM800.print("Tel#1: ");  SIM800.println (TelNumber[1]); EndSMS();
               ...
               isStringMessage = 0;
                  ...
                  if ((signalLevel<5 || signalLevel ==99) && signalLevelstatus!=0) signalLevelstatus --; 
                  else if (signalLevel>=7 && signalLevel !=99) {signalLevelstatus ++; if  (signalLevelstatus>=3)signalLevelstatus = 3;}
