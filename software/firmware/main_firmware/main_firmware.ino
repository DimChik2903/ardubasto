...
const char MQTTUSER[]    =  "jdhgdhkk";                  // имя пользователя (логин)  (смотрим в аккаунте MQTT)
const char MQTTPASSWORD[] = "93ghd4r2h-45";                // пароль                    (смотрим в аккаунте MQTT)
const char SERVERNAME_PORT[] = "\"tailor.cloudmqtt.com\", \"18287\"";  // адрес и порт (смотрим в аккаунте MQTT)
